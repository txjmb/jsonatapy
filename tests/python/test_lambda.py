...
try:
    ...
    print(f"✓ PASS" if result1 == [2, 4, 6, 8, 10] else f"✗ FAIL")
...
try:
    ...
    print(f"✓ PASS" if result2 == [10, 20] else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"Expected: [7, 9, 11]")
    print(f"✓ PASS" if result3 == [7, 9, 11] else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"Expected: 1 item with price 20")
    print(f"✓ PASS" if len(result4) == 1 and result4[0]["price"] == 20 else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"Expected: 15")
    print(f"✓ PASS" if result5 == 15 else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"✓ PASS" if result6 == 120 else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"Expected: ['Item 2', 'Item 3']")
    print(f"✓ PASS" if result7 == ["Item 2", "Item 3"] else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
...
try:
    ...
    print(f"✓ PASS" if result8 == [20, 40, 60] else f"✗ FAIL")
except Exception as e:
    print(f"✗ ERROR: {e}")
