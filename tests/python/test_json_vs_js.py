...
data = {"products": [{"id": i, "name": f"Product {i}", "price": 10.0 + i * 2.5} for i in range(100)]}
...
print(f"  vs JavaScript: {py_json_time/js_time:.2f}x (slower)" if py_json_time > js_time else f"  vs JavaScript: {js_time/py_json_time:.2f}x (faster)")
